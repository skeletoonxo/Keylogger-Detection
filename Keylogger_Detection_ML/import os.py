...
# List files in the directory to verify the path and file name
directory = r'C:\Users\himan\Downloads\Keylogger_Detection_ML'
print("Files in the directory:")
print(os.listdir(directory))

# Load and clean data
print("Starting data processing...")
df = load_and_clean_data(os.path.join(directory, 'process_data.csv'))
